...
1단계 `edzip prepare`는 프로젝트를 분석하고 에듀집 필수기준 5대 영역 9개 항목에 맞춰 개인정보처리방침, 자가점검표, 제품 설명자료, 제출 안내를 HWPX·PDF·Markdown으로 만듭니다. 공식 HWP 원본, 교육부 자료, 법제처 원문 링크, 교사 개인 구글폼, KERIS·에듀집 문의처도 함께 둡니다.
