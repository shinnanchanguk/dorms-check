// Track 2 "에듀집 제출·통과 준비" 카탈로그 (SSOT).
...
export const EDZIP_LEGAL_BASIS = [
  ...
  { law: '교육부 「학습지원 소프트웨어 선정 기준 안내」(2025-12-30)', status: 'reference', effective: '행정 안내자료',
    note: '필수기준 5대 영역과 의견수렴→기준 확인→학운위 심의→학교장 확정 절차의 출처(법령 아님).', link: 'https://www.moe.go.kr/boardCnts/viewRenew.do?boardID=294&boardSeq=105007&lev=0&m=020' },
];
